...
class PriceListTap2SubScreen extends StatefulWidget {
  PriceListTap2SubScreen(
  ...
  int Index;
  @override
  _PriceListTap2SubScreenState createState() => _PriceListTap2SubScreenState();
}

class _PriceListTap2SubScreenState extends State<PriceListTap2SubScreen> {
  ...
  MyPricelistMasterSubTab2Model RawMyPricelistMasterSubTab2Model;
  List<TempMyPricelistMasterSubTab2Model> SecMyPricelistMasterSubTab2Model =
      new List();
            ...
            child: Container(
              ...
              child: SafeArea(
                child: Scaffold(
                  appBar: AppBar(
                    title: Text(
                        "Price List Without Variance -" + widget.PostItemName),
                  ),
                  body: !loading
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: SecMyPricelistMasterSubTab2Model
                                                      .length ==
                                                  0 &&
                                              ReqFromId == 7
                                          ? Center(
                                          ...
                                          : DataTable(
                                              ...
                                              rows:
                                                  SecMyPricelistMasterSubTab2Model
                                                      .map(
                                                (list) => DataRow(cells: [
                                                  DataCell(
                                                    Text(
                                                      ...
                                                      children: [
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () {
                                                            ...
                                                            PriceLisMasteUpdate(5, list.itemCode, list.location, list.active, 2,double.parse(list.rate.toString()));
                                                          },
    ...
    if (response.statusCode == 200) {
      ...
      if (decode["testdata"].toString() == '[]') {
        ...
        // FRONT DATA TBA 1
          ...
          setState(() {
            SecMyPricelistMasterSubTab2Model.clear();
            RawMyPricelistMasterSubTab2Model =
                MyPricelistMasterSubTab2Model.fromJson(
                    jsonDecode(response.body));

            for (int i = 0;
                i < RawMyPricelistMasterSubTab2Model.testdata.length;
                i++)
              SecMyPricelistMasterSubTab2Model.add(
                TempMyPricelistMasterSubTab2Model(
                    RawMyPricelistMasterSubTab2Model.testdata[i].itemCode,
                    RawMyPricelistMasterSubTab2Model.testdata[i].location,
                    RawMyPricelistMasterSubTab2Model.testdata[i].locationName,
                    RawMyPricelistMasterSubTab2Model.testdata[i].variance,
                    RawMyPricelistMasterSubTab2Model.testdata[i].occCode,
                    RawMyPricelistMasterSubTab2Model.testdata[i].occName,
                    RawMyPricelistMasterSubTab2Model.testdata[i].rate,
                    RawMyPricelistMasterSubTab2Model.testdata[i].active,
                    RawMyPricelistMasterSubTab2Model.testdata[i].tapIndex),
              );
            alterloccode = '';
            alterlocname = '';
          });
  ...
  Future<http.Response> PriceLisMasteUpdate(int formId, String itemCode,
      int Loccode, String active, int index,double rate) async {
    var headers = {"Content-Type": "application/json"};
    setState(() {
      loading = true;
...
class BackendService {
  static Future<List> getSuggestions(String query) async {
    ...
    if (_PriceListTap2SubScreenState.ItemList.result.length == 0) {
      Fluttertoast.showToast(
          msg: "No data",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.SNACKBAR,
      ...
      for (int a = 0;
          a < _PriceListTap2SubScreenState.ItemList.result.length;
          a++)
        if (_PriceListTap2SubScreenState.ItemList.result[a].itemName
            .toString()
            .toLowerCase()
            .contains(query.toLowerCase()))
          my.add(ItemFillModel(
              _PriceListTap2SubScreenState.ItemList.result[a].itemCode,
              _PriceListTap2SubScreenState.ItemList.result[a].itemName,
              _PriceListTap2SubScreenState.ItemList.result[a].uOM,
              _PriceListTap2SubScreenState.ItemList.result[a].qty,
              _PriceListTap2SubScreenState.ItemList.result[a].Stock));
      return my;
    }
  }
}
