...
class PriceListTap3SubScreen extends StatefulWidget {
  PriceListTap3SubScreen(
  ...
  int Index;
  @override
  _PriceListTap3SubScreenState createState() => _PriceListTap3SubScreenState();
}

class _PriceListTap3SubScreenState extends State<PriceListTap3SubScreen> {
  ...
  MyPricelistMasterSubTab2Model RawMyPricelistMasterSubTab3Model;
  List<TempMyPricelistMasterSubTab2Model> SecMyPricelistMasterSubTab3Model =
      new List();
        ...
        ? WillPopScope(
            ...
            child: Container(
              ...
              child: SafeArea(
                child: Scaffold(
                  appBar: AppBar(
                    title: Text("Price List With Variance "),
                  ),
                  body: !loading
                                        ...
                                        GetVarianceMaster().then(
                                          (value) => showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                title: Text('Choose The Roll Type..'),
                                                content: Container(
                                                  width: double.minPositive,
                                                  child: ListView.builder(
                                                    shrinkWrap: true,
                                                    itemCount: SecRawPriceListVarianceModel.length,
                                                    itemBuilder: (BuildContext context, int index) {
                                                      return ListTile(
                                                        title: Text(
                                                            SecRawPriceListVarianceModel[index].variance + "-" + SecRawPriceListVarianceModel[index].ItemNos),
                                                        onTap: () {
                                                          setState(() {
                                                            _Variance.text = SecRawPriceListVarianceModel[index].variance;
                                                          });
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: SecMyPricelistMasterSubTab3Model.length == 0 &&
                                              ReqFromId == 7
                                          ...
                                          : DataTable(
                                              ...
                                              rows: SecMyPricelistMasterSubTab3Model.map( (list) => DataRow(cells: [
                                                  DataCell(
                                                    Text(
                                                      ...
                                                      children: [
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () {
                                                            ...
                                                            PriceLisMasteUpdate(5, list.itemCode, list.location, list.active, 3);
                                                          },
  ...
  Future<http.Response> GetVarianceMaster() async {
    ...
    setState(() {
      ...
      SecRawPriceListVarianceModel.clear();
    });
    var body = {
      "FormID": ReqFromId,
      "DocNo": 1,
            ...
            for (int i = 0; i < RawPriceListVarianceModel.testdata.length; i++)
              SecRawPriceListVarianceModel.add(
                TempRawPriceListVarianceModel(
                  ...
                  RawPriceListVarianceModel.testdata[i].ItemNos,
                ),
              );
            loading = false;
          });
    ...
    if (response.statusCode == 200) {
      ...
      if (decode["testdata"].toString() == '[]') {
        ...
        // FRONT DATA TBA 1
          ...
          print(response.body);
          setState(() {
            SecMyPricelistMasterSubTab3Model.clear();
            RawMyPricelistMasterSubTab3Model =
                MyPricelistMasterSubTab2Model.fromJson(
                    jsonDecode(response.body));

            for (int i = 0;
                i < RawMyPricelistMasterSubTab3Model.testdata.length;
                i++)
              SecMyPricelistMasterSubTab3Model.add(
                TempMyPricelistMasterSubTab2Model(
                    RawMyPricelistMasterSubTab3Model.testdata[i].itemCode,
                    RawMyPricelistMasterSubTab3Model.testdata[i].location,
                    RawMyPricelistMasterSubTab3Model.testdata[i].locationName,
                    RawMyPricelistMasterSubTab3Model.testdata[i].variance,
                    RawMyPricelistMasterSubTab3Model.testdata[i].occCode,
                    RawMyPricelistMasterSubTab3Model.testdata[i].occName,
                    RawMyPricelistMasterSubTab3Model.testdata[i].rate,
                    RawMyPricelistMasterSubTab3Model.testdata[i].active,
                    RawMyPricelistMasterSubTab3Model.testdata[i].tapIndex),
              );
            alterloccode = '';
            alterlocname = '';
          });
...
class TempRawPriceListVarianceModel {
  ...
  TempRawPriceListVarianceModel(this.itemCode, this.variance, this.ItemNos);
}
...
class BackendService {
  static Future<List> getSuggestions(String query) async {
    ...
    if (_PriceListTap3SubScreenState.ItemList.result.length == 0) {
      Fluttertoast.showToast(
          msg: "No data",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.SNACKBAR,
      ...
      for (int a = 0;
          a < _PriceListTap3SubScreenState.ItemList.result.length;
          a++)
        if (_PriceListTap3SubScreenState.ItemList.result[a].itemName
            .toString()
            .toLowerCase()
            .contains(query.toLowerCase()))
          my.add(ItemFillModel(
              _PriceListTap3SubScreenState.ItemList.result[a].itemCode,
              _PriceListTap3SubScreenState.ItemList.result[a].itemName,
              _PriceListTap3SubScreenState.ItemList.result[a].uOM,
              _PriceListTap3SubScreenState.ItemList.result[a].qty,
              _PriceListTap3SubScreenState.ItemList.result[a].Stock));
      return my;
    }
  }
}
