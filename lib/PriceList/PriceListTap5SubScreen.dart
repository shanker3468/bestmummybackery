// ignore_for_file: deprecated_member_use, non_constant_identifier_names, must_be_immutable, missing_return
...
class PriceListTap5SubScreen extends StatefulWidget {
  PriceListTap5SubScreen(
  ...
  int Index;
  @override
  _PriceListTap5SubScreenState createState() => _PriceListTap5SubScreenState();
}

class _PriceListTap5SubScreenState extends State<PriceListTap5SubScreen> {
                                    ...
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {
                                          ...
                                          else if (_Variance.text == ""){
                                            Fluttertoast.showToast(msg: "Choose Variance..");
                                          }
                                                      ...
                                                      children: [
                                                        ElevatedButton(
                                                          ...
                                                          onPressed: () {
                                                            ...
                                                            PriceLisMasteUpdate(5, list.itemCode, list.location, list.active, 5);
                                                          },
...
class BackendService {
  static Future<List> getSuggestions(String query) async {
    ...
    if (_PriceListTap5SubScreenState.ItemList.result.length == 0) {
      Fluttertoast.showToast(
          msg: "No data",
          toastLength: Toast.LENGTH_LONG,
          gravity: ToastGravity.SNACKBAR,
      ...
      for (int a = 0;
          a < _PriceListTap5SubScreenState.ItemList.result.length;
          a++)
        if (_PriceListTap5SubScreenState.ItemList.result[a].itemName
            .toString()
            .toLowerCase()
            .contains(query.toLowerCase()))
          my.add(ItemFillModel(
              _PriceListTap5SubScreenState.ItemList.result[a].itemCode,
              _PriceListTap5SubScreenState.ItemList.result[a].itemName,
              _PriceListTap5SubScreenState.ItemList.result[a].uOM,
              _PriceListTap5SubScreenState.ItemList.result[a].qty,
              _PriceListTap5SubScreenState.ItemList.result[a].Stock));
      return my;
    }
  }
}
